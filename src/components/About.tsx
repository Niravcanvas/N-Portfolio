...
export default function About() {
  ...
  const renderFinderContent = () => {
    switch (activeSection) {
      ...
      case 'education':
        return (
          <div>
            <h3 className="font-bold text-white mb-6 flex items-center gap-2" style={{ fontSize: 'var(--text-h3)' }}>
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                ...
                >
                  <h4 className="font-semibold text-white mb-2" style={{ fontSize: 'var(--text-h4)' }}>{edu.degree}</h4>
                  <div className="text-sm text-gray-400 mb-3">{edu.institution} • {edu.period}</div>
                  <p className="text-gray-300" style={{ fontSize: 'var(--text-body)' }}>{edu.description}</p>
                </div>
              ))}
            </div>
          </div>
  ...
  return (
    <section id="about" className="min-h-screen bg-black py-16 md:py-20 lg:py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex justify-center gap-4 mb-6">
          <button
            ...
            className={`px-6 py-2 rounded-xl font-medium transition-all min-h-[44px] ${
              currentView === 'finder'
          ...
          <div className="animate-slide-up">
            <div className="bg-black/90 backdrop-blur-xl border border-white/10 rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="bg-white/5 backdrop-blur-sm px-4 py-3 flex items-center justify-between border-b border-white/10">
                ...
                <div className="text-xs text-gray-500 hidden sm:block">If you are a developer, you can switch to Terminal</div>
              </div>

              {/* Sidebar + Content */}
              <div className="flex flex-col md:flex-row">
                {/* Sidebar */}
                <nav className="w-full md:w-48 bg-white/5 p-4 space-y-2 border-b md:border-b-0 md:border-r border-white/10" aria-label="About sections">
                  ...
                  <div className="flex md:flex-col gap-1 overflow-x-auto md:overflow-x-visible">
                    {[
                      { id: 'about', label: 'About', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clipRule="evenodd" /></svg> },
                      { id: 'education', label: 'Education', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" /></svg> },
                      { id: 'skills', label: 'Skills', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd" /></svg> },
                      { id: 'languages', label: 'Languages', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.633 1.265l-4 12a1 1 0 11-1.898-.632l4-12a1 1 0 011.265-.633zM5.707 6.293a1 1 0 010 1.414L3.414 10l2.293 2.293a1 1 0 11-1.414 1.414l-3-3a1 1 0 010-1.414l3-3a1 1 0 011.414 0zm8.586 0a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 11-1.414-1.414L16.586 10l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" /></svg> },
                      { id: 'libraries', label: 'Libraries', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z" /></svg> },
                      { id: 'software', label: 'Software', icon: <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fillRule="evenodd" d="M2 5a2 2 0 012-2h12a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V5zm3.293 1.293a1 1 0 011.414 0l3 3a1 1 0 010 1.414l-3 3a1 1 0 01-1.414-1.414L7.586 10 5.293 7.707a1 1 0 010-1.414zM11 12a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" /></svg> },
                    ].map((item) => (
                      <button
                        key={item.id}
                        onClick={() => setActiveSection(item.id)}
                        className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm cursor-pointer transition-all whitespace-nowrap min-h-[44px] ${
            ...
            <div className="mt-6 flex flex-wrap gap-2 justify-center">
              {visibleCommandNames.filter((cmd) => cmd !== 'ls' && cmd !== 'guess').map((cmd) => (
                <button
                  ...
                  className="px-3 py-1 text-xs bg-white/5 backdrop-blur-sm hover:bg-white/10 text-gray-300 rounded-lg border border-white/10 transition-all min-h-[44px] flex items-center"
                >
                  /{cmd}
                </button>
              ))}
